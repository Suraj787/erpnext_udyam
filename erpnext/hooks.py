...
scheduler_events = {
	...
	"hourly": [
		...
		# "erpnext.accounts.doctype.subscription.subscription_extend.generate_delivery",
		# "erpnext.accounts.doctype.subscription.subscription_extend.subscriber_next_scheduled_date"
	],
	"daily": [
